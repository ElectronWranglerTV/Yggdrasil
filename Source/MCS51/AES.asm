...
RSEG	AES_ROUTINES
	...
	;*PERFORMS A 128-BIT CBC MODE CIPHER ON 16 BYTES OF DATA
	...
	;	R4		= IV / PREVIOUS CT ADDRESS LSB
	;	R5		= IV / PREVIOUS CT ADDRESS MSB
	;ON RETURN:
	;	DPTR	= 0x0000
	;	R0		= 0x00
	;	R1		= 0x00
	...
	LAESCIPHER128	PROC
		...
		LAESCIPHER128G:
			...
			MOV		R4, A
			POP		B
			;ZEROIZE WORKING REGISTERS & RETURN
			CLR		A
			MOV		R0, A
			MOV		R1, A
			MOV		R2, A
