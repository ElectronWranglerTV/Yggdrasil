...
EXTRN	CODE	(DPTRBADD,      DPTRWADDAB,   DPTRBGMRDONA, DPTRBGMRDONO)
EXTRN	CODE	(DPTRBGMRDONX,  DPTRBLRXDON,  DPTRBSRXDON,  DPTRWLDXDNN)
EXTRN	CODE	(DPTRWLDXDON,   DPTRWLRXDON,  DPTRWSXRDNN,  DPTRWSXRDON)
EXTRN	CODE	(DPTRBAMRDONA,  DPTRBARMDONS, DPTRBGRMDONX)
EXTRN	CODE	(MEMALCXRAM,    MEMFREEXRAM)
EXTRN	CODE	(TASKCURR)

PUBLIC  LFIFOINIT,      LFIFODELETE,    LFIFOCREATE,  LFIFOISEMPTY
PUBLIC  LFIFOISFULL,    LFIFOREADBYTE,  LFIFOREADSTR, LFIFORESET
PUBLIC  LFIFOWRITEBYTE, LFIFOWRITESTR
...
;*RESETS THE SPECIFIED FIFO'S READ AND WRITE INDICIES,
